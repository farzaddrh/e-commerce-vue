      ...
      <div class="product-image-slider">
        <div class="product-img-large-slider">
          <div class="img-large-slider-container">
            <img
              :src="
                require(`@/assets/images/image-product-${currentSlide}.jpg`)
              "
          ...
          <div class="next" @click="goNextSlide">
            <img
              :src="require('@/assets/images/icon-next.svg')"
              alt="iconNext"
            />
          </div>
        ...
        <div class="product-imgs-small-slider">
          <div
            class="img-small-container-slider"
            v-for="i in 4"
            :key="i"
            @click="activateSlide(i)"
            :class="{ active: currentSlide === i }"
          >
            <img
              class="img-small-slider"
